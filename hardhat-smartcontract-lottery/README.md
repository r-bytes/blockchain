...
```
git clone --branch typescript https://github.com/r-bytes/blockchain/tree/main/hardhat-smartcontract-lottery
...
```
yarn hardhat run scripts/enter.ts --network sepolia
```
